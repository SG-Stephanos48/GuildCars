...
BEGIN
	...
	INSERT INTO Car (CarId, MakeId, ModelId, CarTypeId, BodyStyleId, MfgYear, TransId, ColorId, InteriorId, Mileage, VIN, MSRP, SalesPrice, CarDescription, ImageFileName, PurchaseId, Feature)
	VALUES (1, 1, 1, 1, 2, '2021', 1, 1, 2, '150', 'F2020600000343', 23950, 21000, 'New car w/ great personality', 'car.jpg', 1, 1),
	(2, 2, 2, 1, 1, '2021', 2, 2, 3, '76', 'VW20210000T2010', 27500, 24000, 'New car that speaks German', 'car.jpg', 2, 0),
	(3, 3, 3, 1, 4, '2018', 1, 4, 3, '14500', 'DS20210000T2018', 32500, 27500, 'Lightly used Sprinter Van', 'car.jpg', 3, 1),
	(4, 4, 4, 2, 3, '2021', 1, 3, 3, '19', 'DS20210000T2032', 37500, 32500, 'Dream truck', 'car.jpg', 4, 0),
	(5, 5, 5, 2, 1, '1965', 1, 2, 3, '100', 'DS20210034323432', 92500, 75900, 'Incredible ', 'car.jpg', 5, 1);
